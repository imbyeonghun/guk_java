# 사용자가 아이디가 abc123, 비번이 asd123인 회원가입을 진행
...
# CGV에서 영화 웡카를 관리자가 등록하려고 할때 해야하는 쿼리를 순서 대로 써보세요
# 영화(제목, 내용, 개봉일, 상영시간), 감독, 배우들, 장르, 연령, 제작 국가, 트레일러, 스틸컷
...
values(null,'폴킹','1978-07-29','폴킹','미국'),
(null,'티모시 살라메','1995-12-27','티모시 살라메','미국'),
(null,'칼라 레인','2009-04-20','칼라 레인','미국'),
(null,'올리비아 콜맨','1974-01-30','올리비아 콜맨','영국'),
(null,'톰 데이비스','1979-04-27','톰 데이비스','영국'),
(null,'휴 그랜트','1960-09-09','휴 그랜트','영국'),
(null,'샐리 호킨스','1976-04-27','샐리 호킨스','영국');
select * from `character`;

# 2. 폴킹, 티모시 샬라메 ,  칼라 레인 ,  올리비아 콜맨 ,  톰 데이비스 ,  휴 그랜트 ,  샐리 호킨스 정보를
# movie_person 테이블에 추가(1번에서 추가한 정보를 이용)
...
# join 테이블에 추가(2, 3번에서 추가한 정보를 이용), 배역을 모르면 ""로
